...
public class DataQueryGeneratorValueYTest {
    ...
    public void setUp() throws Exception {
        ...
        templateValues.put("value_y", "valueY");
    ...
    public void testDataEqualsQueryGeneratorGetQuery() {
        ...
        String expectedQuery = "SELECT case_id FROM eventLogTable WHERE `attributeX` != 'valueY' GROUP BY case_id";
