...
public class ControlFlowPrecedesQueryGeneratorTest {
    ...
    private ControlFlowPrecedesQueryGenerator controlFlowPrecedesQueryGenerator; // Notice this change
    ...
    public void setUp() throws Exception {
        ...
        controlFlowPrecedesQueryGenerator = new ControlFlowPrecedesQueryGenerator(eventLogModel, new HashMap<>()); // And this line
    }
    ...
    public void testGetQuery() {
        ...
        controlFlowPrecedesQueryGenerator.processQueryParameters(templateValues);

        String actualQuery = controlFlowPrecedesQueryGenerator.getQuery();
        String expectedQuery =
                "SELECT DISTINCT a1.case_id FROM eventLogTable AS a1 JOIN eventLogTable AS a2 ON a1.case_id = a2.case_id WHERE a1.activity = 'TaskP' AND a2.activity = 'TaskQ' AND a1.start_time > a2.start_time";
