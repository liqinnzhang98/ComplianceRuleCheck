...
public class ControlFlowDirectlyFollowedByQueryGeneratorTest {
    ...
    private ControlFlowDirectlyFollowedByQueryGenerator controlFlowDirectlyFollowedByQueryGenerator;
    ...
    public void setUp() throws Exception {
        ...
        controlFlowDirectlyFollowedByQueryGenerator = new ControlFlowDirectlyFollowedByQueryGenerator(eventLogModel, new HashMap<>());
    }
    ...
    public void testGetQuery() {
        ...
        controlFlowDirectlyFollowedByQueryGenerator.processQueryParameters(templateValues);

        String actualQuery = controlFlowDirectlyFollowedByQueryGenerator.getQuery();
        String expectedQuery =
                "SELECT DISTINCT a1.case_id FROM eventLogTable AS a1 JOIN eventLogTable AS a2 ON a1.case_id = a2.case_id WHERE a1.activity = 'TaskP' AND a2.activity = 'TaskQ' AND EXISTS (SELECT 1 FROM eventLogTable AS a3 WHERE a3.case_id = a1.case_id AND a3.start_time > a1.start_time AND a3.start_time < a2.start_time)";
